          ...
          <div className="relative w-full max-w-5xl flex flex-col items-center justify-center mt-2 sm:mt-4">
            ...
            <div className="flex flex-col items-center z-10">
              ...
              <a
                ...
                className="mt-10 sm:mt-12 px-6 sm:px-8 py-3 sm:py-3.5 rounded-full bg-[#25D366] text-white font-bold tracking-[0.08em] sm:tracking-wider text-xs sm:text-sm hover:bg-[#1fad53] hover:shadow-[0_0_20px_rgba(37,211,102,0.3)] transition-all flex items-center gap-2.5 sm:gap-3"
              >
